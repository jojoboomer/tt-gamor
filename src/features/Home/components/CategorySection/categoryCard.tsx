...
const CategoryCard = ({ className, category, index }: Props) => {
  return (
    <Card
      className={cn(
        "group relative aspect-video w-full lg:w-auto h-40 flex-col-reverse items-end bg-center bg-cover hover:cursor-pointer border border-gray-400 dark:border-primary ",
        className
      )}
